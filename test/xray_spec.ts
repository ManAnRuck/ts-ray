  ...
  xit("should work with complex selections", function (done) {
    ...
    x("http://mat.io", {
      ...
      assert.deepEqual(
        {
          ...
          description:
            "Relive your childhood with TIME's list of the best 100 children's books of all time http://t.co/NEvBhNM4np http://ift.tt/1sk3xdM\n\n— TIME.com (@TIME) January 11, 2015",
        },
        obj.items.pop()
      );
      ...
      assert.deepEqual(
        {
          title:
            "Republicans Expose Obama’s College Plan as Plot to Make People Smarter - The New Yorker",
          description:
            "Republicans Expose Obama’s College Plan as Plot to Make People Smarter http://t.co/OsvoOgn8Tn\n\n— Assaf (@assaf) January 11, 2015",
        },
        obj.items.pop()
      );
  ...
  describe(".then(cb, err)", function () {
    ...
    it("should Promisify and pass rejections to promise", function () {
      ...
      return promise.then(function () {
        ...
        assert(
          errorHandler.firstCall.args[0] instanceof Error,
          "called with error"
        );
      });
    });
